...
public class View {
    ...
    public static void view() {
        ...
        tabSetter(Program.blue.get(0).toString().length(), l[0]);
        ...
        for (int i = 2; i < 9; i++) {
            ...
            tabSetter(Program.blue.get(i-1).toString().length(), l[0]);
            System.out.println(Program.green.get(i-1));
            System.out.println(midl10);
        }
        for (int j = 1; j < 11; j++) {
        ...
        tabSetter(Program.blue.get(9).toString().length(), l[0]);
        System.out.println(Program.green.get(9));
